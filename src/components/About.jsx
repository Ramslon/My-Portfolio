  ...
  return (
    <section id="about" className="py-20 px-6 md:px-20 bg-white dark:bg-gray-900 scroll-mt-24">
        ...
        <h1 className="text-2xl md:text-3xl font-semibold mb-4 text-center text-gray-800 dark:text-gray-100">
          I am a Software Engineering Student at Kirinyaga University passionate about building modern web and mobile applications using<span className="text-blue-600"> React, Flutter, and Node.js</span>. I love creating innovative solutions and continuously learning new technologies.
        </h1>
